            ...
            <Row className="row row-grid align-items-center">
              ...
              <Col className="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                <h1 className="display-4 text-center text-md-left mb-3">
                  Crie publicações acessíveis com o{" "}
                  <strong className="text-primary">Descript</strong>
                </h1>
                <h2 className="lead text-center text-md-left text-muted">
                  Faça o upload de fotos e vídeos e receba a descrição
                  profissional para publicar o seu conteúdo de forma acessível
                  para todos.
                </h2>
              </Col>
            </Row>
            ...
            <Row className="row row-grid align-items-center">
              ...
              <Col className="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                ...
                <p className="lead text-center text-md-left text-muted">
                  Descript é um serviço de descrição de imagens por assinatura
                  online. Nós criamos uma plataforma de tecnologia para agilizar
                  e automatizar todos os processos de contratação, criação e
                  aprovação de descrição de imagem, que são feitas pelos
                  melhores profissionais do mercado. Nossos assinantes podem
                  focar na criação de conteúdo e deixar a acessibilidade com a
                  gente.
                </p>
              </Col>
            </Row>
              ...
              <Col md="4">
                <div className="card border-0 bg-soft-danger">
                  <div className="card-body pb-5">
                    ...
                    <h3 className="h4 lh-130 text-dark mb-3">
                      Aumentar o seu público potencial
                    </h3>
                    <p className="text-dark opacity-6 mb-0">
                      Pessoas com deficiência acessam a internet e se os
                      conteúdos das suas redes sociais e do seu site forem
                      acessíveis, elas serão impactadas.
                    </p>
                  </div>
                </div>
              </Col>
              <Col md="4">
                <div className="card border-0 bg-soft-success mt-lg-5">
                  <div className="card-body pb-5">
                    ...
                    <p className="text-dark opacity-6 mb-0">
                      Utilizar o texto alternativo de forma correta no seu site
                      é uma boa prática que otimiza seu site em mecanismos de
                      busca como o Google.
                    </p>
                  </div>
                </div>
              ...
              <Col md="4">
                <div className="card border-0 bg-soft-warning mt-lg-7">
                  <div className="card-body pb-5">
                    ...
                    <h3 className="h4 lh-130 text-dark mb-3">
                      Descrição profissional de imagem
                    </h3>
                    <p className="text-dark opacity-6 mb-0">
                      Acessibilidade é importante para o sucesso dos seus
                      negócios; acessibilidade feita profissionalmente pode ser
                      um diferencial.
                    </p>
                  </div>
                </div>
