            ...
            <Row className="row row-grid align-items-center">
              ...
              <Col className="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                ...
                <h2 className="lead text-center text-md-left text-muted">
                  Faça o upload de fotos e vídeos e receba a descrição profissional para publicar o seu conteúdo de
                  forma acessível para todos.
                </h2>
              </Col>
            </Row>
          </Container>
              ...
              <Col md="4">
                <div className="card border-0 bg-soft-success mt-lg-5">
                  <div className="card-body pb-5">
                    ...
                    <p className="text-dark opacity-6 mb-0">
                      Utilizar o texto alternativo de forma correta no seu site é uma boa prática que otimiza seu site
              ...
              <Col md="4">
                <div className="card border-0 bg-soft-warning mt-lg-7">
                  <div className="card-body pb-5">
                    ...
                    <p className="text-dark opacity-6 mb-0">
                      Acessibilidade é importante para o sucesso dos seus negócios; acessibilidade feita
                      profissionalmente pode ser um diferencial.
                    </p>
                  </div>
                </div>
              </Col>
